            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 bg-surface-50 dark:bg-surface-800/40 rounded-3xl border border-surface-100 dark:border-surface-700/50">
              ...
              <div class="flex flex-col gap-2">
                ...
                <div class="relative w-full">
                  ...
                  <input type="text" pInputText [(ngModel)]="settings.phone" class="w-full rounded-xl pl-12 dark:bg-surface-900 border-surface-200 dark:border-surface-700 relative z-10">
                </div>
              </div>
...
export class InvoiceSettingsComponent {
  ...
  saveSettings() {
    ...
    setTimeout(() => {
      ...
      // In a real scenario, you'd typically send this.settings to your backend.
    }, 800);
  }
}
