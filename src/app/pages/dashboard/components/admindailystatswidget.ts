            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                <div>
                    <h5 class="text-xl font-black text-surface-900 dark:text-white flex items-center gap-2">
                        ...
                        إحصائيات الأداء اليومي (للموظفين)
                    </h5>
                    <p class="text-xs text-surface-500 font-bold mt-1">متابعة فورية للحضور والانقطاع والعملاء الجدد لليوم</p>
                </div>
                <div class="flex items-center gap-4 bg-emerald-50 dark:bg-emerald-900/20 px-6 py-3 rounded-2xl border border-emerald-100 dark:border-emerald-800/30">
                    <div class="flex flex-col items-end">
                        <span class="text-[10px] text-emerald-600 dark:text-emerald-400 font-black uppercase tracking-wider">إجمالي المحتملين اليوم</span>
            ...
            <div class="overflow-x-auto">
                <p-table [value]="employeePerformance" [responsiveLayout]="'scroll'" styleClass="p-datatable-sm">
                    <ng-template pTemplate="header">
                        <tr>
                            <th class="text-xs font-black uppercase tracking-wider">الموظف</th>
                            <th class="text-xs font-black uppercase tracking-wider">الحالة</th>
                            <th class="text-xs font-black uppercase tracking-wider text-center">أول دخول</th>
                            <th class="text-xs font-black uppercase tracking-wider text-center">التأخير</th>
                            <th class="text-xs font-black uppercase tracking-wider text-center">إجمالي الانقطاع</th>
                            <th class="text-xs font-black uppercase tracking-wider text-center">الخصومات</th>
                        </tr>
                    </ng-template>
                        ...
                        <tr class="hover:bg-surface-50 dark:hover:bg-surface-800/50 transition-colors border-b border-surface-100 dark:border-surface-800 last:border-0">
                            ...
                            <td class="text-center">
                                <span class="font-black text-xs text-red-600 bg-red-50 dark:bg-red-900/20 px-2 py-1 rounded-lg">
                                    {{ perf.deductionAmount | number:'1.0-0' }} ج.م
                                </span>
                            </td>
                        </tr>
                    </ng-template>
                    <ng-template pTemplate="emptymessage">
                        <tr>
                            <td colspan="6" class="text-center p-8 text-surface-400 font-bold text-sm">لا يوجد موظفين مسجلين حالياً</td>
                        </tr>
                    </ng-template>
                </p-table>
            </div>
